      ...
      <div v-if="showModal" class="modal-overlay" @click="showModal = false">
        <div class="modal-content" @click.stop>
          ...
          <div class="modal-section">
            <h4 class="modal-subtitle">Управление вершинами:</h4>
            <ol class="modal-list">
              <li>
                <b>Захват и перемещение вершины</b>:
                <ul
                  style="
                    margin-top: 0.5rem;
                ...
                >
                  <li>
                    После замыкания полигона наведите курсор на вершину (курсор
                    станет <b>рукой</b>)
                  </li>
                  <li>
                    Зажмите ЛКМ на вершине и перемещайте мышь — вершина будет
                    двигаться
                  </li>
              ...
              <li>
                Вершины с ошибками (малый угол, совпадение, перегиб) —
                <span style="color: #dc2626">пустой красный круг</span>
              </li>
